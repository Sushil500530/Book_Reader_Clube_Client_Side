                        ...
                        <div className='grid grid-cols-1 dark:text-white w-full lg:w-2/3 mx-auto'>
                            <div className='space-y-6'>
                                <div className='flex flex-col md:flex-row lg:flex-row gap-4 items-center justify-center'>
                                    <div className='space-y-2 w-full'>
                                        ...
                                        <input
                                            ...
                                            name='full_name' id='full_name' type='text' placeholder='enter your full name...' required
                                        />
                                    </div>
                                ...
                                <div className='space-y-1 '>
                                    ...
                                    <textarea id='message' className='block focus:rose-300 w-full h-32 px-4 py-3 text-gray-800  border rounded-md  border-blue-400 ' name='message' placeholder="write message..."
                                    ></textarea>
                                </div>
                            </div>
