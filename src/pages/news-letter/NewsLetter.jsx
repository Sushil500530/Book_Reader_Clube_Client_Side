    ...
    return (
        <div className="lg:max-w-[2520px] h-auto mx-auto xl:px-20 w-full mt-12">
            <div className="relative w-full h-[60vh] lg:h-[40vh] flex items-center justify-center bg-white lg:p-12 p-5">
                <img
                    src="https://i.ibb.co/Np7DR2P/3585405.webp"
                    alt="image"
                    className="w-full h-full absolute opacity-50 z-10"
                />
                <div className="z-10 flex items-center justify-between gap-16 lg:gap-6 w-full flex-col lg:flex-row">
                    ...
                    <form
                        ...
                        className="w-full lg:1/2 relative"
                    >
                        <input
                            className='w-full px-4 py-5 rounded-full text-gray-800 border border-blue-400 shadow-xl '
                            name='email'
                            id='email'
                            type='email'
                        ...
                        <button
                            ...
                            <FaTelegramPlane className="text-2xl md:hidden block" />
                        </button>
                    </form>
                </div>
            </div>
