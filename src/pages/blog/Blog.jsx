    ...
    return (
        <Container>
            <div className=" w-full md:w-2/3 lg:w-2/3 mx-auto flex items-end justify-end my-8">
                <div className=" w-32 h-auto bg-base-100 shadow-xl p-2 cursor-pointer rounded-full text-center">
                    Create Post
                    </div>
            </div>
            <div className=" w-full md:w-2/3 lg:w-2/3 mx-auto flex flex-col gap-5">
                <div className="flex items-center justify-between px-5">
                    <div className="flex items-center gap-3">
                        <figure className="w-12 h-12 rounded-full">
                            <img
                                src="https://i.ibb.co/WfPnV0V/sushil-bg.png"
                                alt="person-image"
                ...
                <div className="px-3">
                    <figure className="w-full h-[500px]">
                        <img
                            src="https://i.ibb.co/M2V49sL/lotika.jpg"
                            alt="post-image"
                    ...
                    <div className="p-3">
                        <div className="flex items-center justify-between">
                            ...
                            <div>
                                <h1 className="hover:underline text-neutral-500 cursor-pointer">
                                    1 Comment
                                </h1>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center justify-around ">
                            <div className="group relative">
                                ...
                                <div className="transition transform translate-y-2 ease-in-out invisible absolute group-hover:visible md:-left-20 lg:-left-20 w-[300px] h-auto text-white group-hover:-translate-y-20 bg-white shadow flex items-center gap-2 p-0 rounded-full">
                                    <button
                                        ...
                                        className="flex items-center gap-2 text-xl text-neutral-700 p-1"
                                    >
                                        <img
                                            src={like}
                                            alt="like"
                                            className="w-10 h-10 hover:scale-105 hover:-translate-y-2 duration-200 transition"
                                        />
                                    </button>
                                    <button
                            ...
                            <button className="flex items-center gap-2 lg:text-xl md:text-lg text-base text-neutral-700 active:bg-slate-200 px-4 py-2 rounded-full">
                        ...
                        <p className="hover:underline text-neutral-500 cursor-pointer inline-block">
                            View More Comments
                        </p>
                        <div className="flex items-start gap-3">
                            ...
                            <div className="bg-slate-100 rounded-2xl shadow-md p-3">
                                <h1 className="text-base font-semibold text-start hover:underline cursor-pointer inline-block">
                                    Sushil Apurbo
                                </h1>
                                <p>
                                    Wow nice photo!❤️❤️ Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus vel perspiciatis, est iusto repudiandae culpa sed doloribus! Nihil delectus reprehenderit eaque adipisci. Consequatur fugiat hic ea eos facilis soluta ab.
                                </p>
                            </div>
                        </div>
                    </div>
