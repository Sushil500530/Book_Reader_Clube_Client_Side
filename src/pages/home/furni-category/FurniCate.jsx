...
const FurniCate = () => {
    ...
    return (
        <Container>
            ...
            <p className="text-sm text-black/80 text-center mb-8 mt-2 lg:w-[550px] mx-auto">Discover a curated collection of stylish, high-quality furniture designed to transform your spaces effortlessly.</p>
