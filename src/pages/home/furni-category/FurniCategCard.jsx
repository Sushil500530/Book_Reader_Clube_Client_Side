    ...
    return (
        <div>
            <div className="m-5 cursor-pointer w-auto h-[280px] md:h-[320px] lg:h-[350px] relative group rounded-lg hover:rounded-lg overflow-hidden">
                ...
                <div className='bg-color z-10 pb-6 absolute w-full h-auto inset-y-0 flex items-center hover:opacity-90 justify-center flex-col transform lg:block translate-y-full group-hover:translate-y-0 dark:text-white transition duration-200 ease-in-out'>
