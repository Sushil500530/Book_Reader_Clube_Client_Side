        ...
        <div className="w-full lg:h-screen h-auto bg-[url('https://i.ibb.co/wh2Vr39/banner5.gif')] bg-no-repeat bg-cover">
            ...
            <div className="flex items-center justify-center pt-32 flex-col lg:flex-row gap-12 lg:px-24 p-5">
                <div className="w-full lg:w-1/2 flex items-start justify-center flex-col z-10">
                    <h1 className="font-extrabold text-2xl md:text-5xl lg:text-5xl bg-gradient-to-t from-white to-[#ff0fdb] bg-clip-text text-transparent leading-normal text-start">
                    ...
                    <div className="flex items-center justify-center gap-5 my-10">
                        <button className="bg-color text-white rounded flex gap-2 items-center text-[18px] font-medium px-4 py-2  duration-200 transform hover:text-gray-200 hover:-translate-y-[2px] transition-all ease-in hover:scale-100 ">
