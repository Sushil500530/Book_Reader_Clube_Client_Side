...
const ManageProduct = () => {
    ...
    return (
        <div className="w-full h-auto mb-10">
            <h1 className="text-3xl text-center font-bold my-5 flex items-center justify-center gap-2 font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#0939e9] to-[#ff0fdb]">Manage Your Products</h1>
