            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 mt-12">
                {
                    currentItems?.length > 0 && currentItems?.map(furniture =>
                        <div key={furniture?._id} className="bg-gradient-to-b from-[#2241b0] to-[#000000] transition ease-in-out text-white transition ease-in-out text-2xl text-center w-full h-auto shadow-2xl relative rounded-md mb-10 ">
